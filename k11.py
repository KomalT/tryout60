# -*- coding: utf-8 -*-
"""
Created on Sat Jan 09 20:17:54 2016
...
def derivate(y,t):
    ...
    xm=y[4]/(y[3]+y[4]+y[5])
    #xw=y[5]/(y[3]+y[4]+y[5])
    dGc=-kla*A*(yc*pT/Hc-MDc*xc)*10**3
    dLc=-kla*A*(yc*pT/Hc-MDc*xc)*10**3
    dGm=-kla*A*(ym*pT/Hm-MDm*xm)*10**3
    dLm=-kla*A*(ym*pT/Hm-MDm*xm)*10**3
    dGw=kGa*A*(pT*yw-Pwsat)
    dLw=kGa*A*(pT*yw-Pwsat)
    return array([dGc,dLc,dGm,dLm,dGw,dLw])
def error(y):
    e1=100-y[9,5]#"liq water"
    e2=y[9,4]#"liq CH4"
    e3=y[9,3]#"liq CO2"
